...
namespace Estoque.BLL
{
    public class BLL_Conexao
    {
        ...
        {
            SqlConnection conexao = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""G:\Tecnico em Informatica\Estoque_XX\Estoque\Bd_Estoque.mdf"";Integrated Security=True;Connect Timeout=30");
